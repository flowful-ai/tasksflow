...
ALTER TABLE "workspace_invitations" ADD COLUMN IF NOT EXISTS "max_uses" integer;
--> statement-breakpoint
-- Add uses_count column to track usage
ALTER TABLE "workspace_invitations" ADD COLUMN IF NOT EXISTS "uses_count" integer DEFAULT 0 NOT NULL;
